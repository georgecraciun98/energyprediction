...
class Showplot(View):
    def get(self,request,*args,**kwargs):
            ...
            if kwargs['type']:
                ...
                dataset=read_csv(r'S:\Practica\EnergyPrediction\energyprediction\energysite\household_power_consumption_days.csv',header=0,
                        infer_datetime_format=True
                ...
                if model_type =="lstm_encoder_decoder":
                    score_rmse, scores_rmse, score_mae, scores_mae=encode_decoder(train,test,n_input)
                else:
                    score_rmse, scores_rmse, score_mae, scores_mae=ev_model(train,test,n_input)
